...
async def _run_react_inner(
    ...
    current_messages: list = list(state.get("messages", []))
...
def _build_result(messages: list, step_count: int) -> dict[str, Any]:
