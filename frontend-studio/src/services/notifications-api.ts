/**
 * Notifications API service — wraps backend /notifications endpoints.
 *
 * Mirrors frontend/src/services/notifications-api.ts, adapted to the studio's
 * relative import layout (apiClient lives in ../lib/api-client).
...
export const notificationsApi = {
  list(params?: { page?: number; page_size?: number; read?: boolean; kind?: string }) {
    return apiClient
      .get<NotificationListResponse>('/api/v1/notifications', { params })
      .then((r) => r.data)
  },
