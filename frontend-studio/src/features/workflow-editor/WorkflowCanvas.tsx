 ...
 */
import { useCallback, useRef, useState, useEffect, useMemo, type MouseEvent as ReactMouseEvent, type DragEvent as ReactDragEvent } from 'react'
import {
  ReactFlow,
  MiniMap,
  Controls,
    ...
    <div className="w-full h-full">
      ...
      >
        ...
        <MiniMap
          ...
          maskColor={theme === 'dark' ? 'rgba(0,0,0,0.5)' : 'rgba(0,0,0,0.08)'}
          className={`!rounded-lg !border ${theme === 'dark' ? '!border-[#27272a] !bg-[#121214]' : '!border-gray-200 !bg-white'}`}
