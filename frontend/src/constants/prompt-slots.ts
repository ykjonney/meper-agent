...
export const FIXED_SLOTS: SlotDef[] = [
  { name: 'role', label: '角色定义', required: true, placeholder: '定义 Agent 的身份、人格和专业能力，例如："你是一位资深客服专家，擅长用温和的语气解答用户问题"' },
  { name: 'task', label: '任务描述', required: true, placeholder: '描述 Agent 的核心职责和工作目标，例如："根据用户的问题，提供准确、简洁的解答"' },
